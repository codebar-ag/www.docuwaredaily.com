<x-layouts.default>
   ...
   {{--             <img class="h-11" src="https://tailwindui.com/img/logos/mark.svg?color=blue&shade=600"
                ...
                <h1 class="mt-10 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Connect with other
                    DocuWare
                    Partners</h1>
                <p class="mt-6 text-lg leading-8 text-gray-600">DocuWare Daily is a DocuWare Partners community to
                    exchange
                ...
                <div class="mt-10 space-y-4 md:space-y-0 md:flex items-center gap-x-6">
                    <a target="_blank" onclick="fathom.trackGoal('V95QRZCC', 0);"
                       ...
                       class="flex items-center rounded-md bg-blue-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
                        <svg class="h-6 w-6 fill-current" xmlns="http://www.w3.org/2000/svg" height="1em"
                             viewBox="0 0 448 512">
            ...
            <div class="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
                <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                    <div class="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                        <img src="https://res.cloudinary.com/codebar/image/upload/c_scale,dpr_2.0,f_auto,q_auto,w_2000/www-docuwaredaily-com/project-app-screenshot.webp"
                             alt="DocuWare Cloud" width="2432" height="1442"
...
{{--    <div class="bg-blue-100">
        <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:justify-between lg:px-8">
            ...
            <div class="mt-10 flex items-center gap-x-6 lg:mt-0 lg:flex-shrink-0">
                <a href="#"
                   class="rounded-md bg-blue-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Open
                    Challenges</a>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="mt-16 flex justify-center">
                <p class="relative rounded-full bg-gray-50 px-4 py-1.5 text-sm leading-6 text-gray-600 ring-1 ring-inset ring-gray-900/5">
                    <span class="hidden md:inline">Join the DocuWare Daily community and Signup today</span>
                    <a href="#" class="font-semibold text-blue-600"><span class="absolute inset-0"
                                                                          aria-hidden="true"></span>Signup today</a>
                </p>
            </div>
        </div>
    </div>--}}
        ...
        <div class="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:gap-8 lg:px-8">
            ...
            <form class="w-full max-w-md lg:col-span-5 lg:pt-2">
                ...
                <p class="mt-4 text-sm leading-6 text-gray-300">We care about your data. Read our <a href="#"
                                                                                                     class="font-semibold text-white hover:text-blue-50">privacy&nbsp;policy</a>.
                </p>
            </form>
        </div>
    </div>--}}
